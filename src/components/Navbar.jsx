...
const Navbar = ({ mode, toggleMode }) => {
  ...
  return (
    <nav className="navbar glass-navbar">
      <div className="logo">Prime Factorization</div>
      <div style={{ display: 'flex', alignItems: 'center', marginLeft: 'auto', position: 'relative' }}>
        <ul className="nav-links">
          <li><a href="/">Home</a></li>
          <li><a href="https://drive.google.com/file/d/1lWTgp-Ekn0EpgoQM1u-AkIzT-rU-WSgS/view?usp=drive_link" >Resume</a></li>
          <li><a href="#links" onClick={handleNavClick}>Links</a></li>
        </ul>
        {dropdownOpen && (
